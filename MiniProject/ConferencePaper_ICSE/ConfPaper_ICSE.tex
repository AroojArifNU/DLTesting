...
Deep Neural Networks (DNNs) are widely recognized for their lack of robustness. Research has demonstrated that DNNs are susceptible to two primary categories of adversarial interventions: \emph{adversarial attacks} and \emph{input transformations}.
