...
\alex{Missing references} In the past, researchers have extensively discussed both verification and testing techniques, which are useful for evaluating the DNNs. Verification involves proving the property of a model through mathematical proof. For example, if you change the input slightly, the model should still provide an accurate prediction. 
