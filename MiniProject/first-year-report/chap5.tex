...
I will draft the thesis, integrating all research objectives, methodologies, and results. This will involve organizing and presenting comprehensive findings.
...
\begin{table*}[ht]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|l|}
      ...
      {\color[HTML]{404040} Journal paper 2 (IEEE Transaction on Software Engineering)} & Obj1, 3, 5, 7 \\ \hline
...
\ganttmilestone[
  milestone/.append style={shape=circle, fill=red, minimum size=3mm},
  milestone label font=\bfseries\footnotesize\color{black},
  milestone label node/.append style={right=142mm, yshift=0mm}
...
\ganttmilestone[
  milestone/.append style={shape=circle, fill=red, minimum size=3mm},
  milestone label font=\bfseries\footnotesize\color{black},
  milestone label node/.append style={right=105mm, yshift=0mm}
]{Thesis submission(MS8)}{2026-7-30}\\
\ganttmilestone[
  milestone/.append style={shape=circle, fill=red, minimum size=3mm},
  milestone label font=\bfseries\footnotesize\color{black},
  milestone label node/.append style={right=109mm, yshift=0mm}
...
\caption{Gantt chart illustrating the timeline and progress of research milestones and tasks.}
\label{phdplan}
\end{figure}
