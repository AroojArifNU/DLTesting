...
\usepackage{graphicx} % Needed for \rotatebox
...
\lstset{
    language=Python,
    basicstyle=\ttfamily\tiny, % Smaller font size
    ...
    columns=flexible, % Allow flexible column width
}
\makeatletter
...
% % \include{How to read this document}
\include{chap1}
\include{chap2}
\include{chap3}
\include{chap4}
