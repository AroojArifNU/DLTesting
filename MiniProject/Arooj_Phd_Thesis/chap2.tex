...
The following thematic wheel diagram illustrates the interconnected modules essential for developing a robust testing framework for Deep Neural Networks (DNNs). Each module highlights a key area of focus, demonstrating the comprehensive approach needed to ensure the reliability and effectiveness of DNNs in safety-critical applications.

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{literature.png}
