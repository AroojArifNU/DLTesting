...
To develop a comprehensive testing framework, it is crucial to explore various domains that collectively contribute to this goal. The literature review is categorized into seven themes, each playing a vital role in the framework. Figure. \ref{fig:thematic_wheel} illustrates the interconnected modules essential for framework development. Each module highlights a key area of focus, demonstrating the comprehensive approach needed to ensure the robustness of DNNs in safety-critical applications.

To develop a comprehensive testing framework for DNNs, it is crucial to explore various domains that collectively contribute to this goal. This literature review aims to discuss the foundational concepts of DNNs and their significance in AI systems, followed by an examination of the robustness of DNNs. Subsequently, the review will be categorized into seven themes, each playing a vital role in the framework. Figure \ref{fig:thematic_wheel} illustrates the interconnected modules essential for framework development. Each module highlights a key area of focus, demonstrating the comprehensive approach needed to ensure the robustness of DNNs in safety-critical applications.
...
DNNs are known for their lack of robustness. Research has shown DNNs to be vulnerable to two main categories of adversaries \cite{Hosseini}: \emph{adversarial examples}~\cite{adv_attacks} and \emph{semantic adversarial examples}~\cite{deeptest}.
