...
\cite{deeptest} & \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
  \hline
\cite{Wicker et al., 2018}& \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
\cite{Ma et al., 2018}& \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
  \hline
\cite{SunY,Sun et al., 2019}& \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
\hline
\cite{Sun et al., 2019}& \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
\hline

\cite{Cheng et al., 2018} & \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
\hline
\cite{Kim et al., 2018} & \tickNo & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
\hline
...
\hline
\cite{Gopinath et al., 2018} & \tickNo & \tickNo & \tickNo & \tickYes & \tickNo & \tickNo \\
\hline
\cite{Agarwal et al., 2018} & \tickNo & \tickNo & \tickNo & \tickYes & \tickNo & \tickNo \\
\hline
\cite{Zhang et al., 2018} & \tickNo & \tickNo & \tickNo & \tickYes & \tickNo & \tickNo \\
\hline
